...
class DAP(nn.Module):
    def __init__(self, args):
        ...
        # Get the folder this file is in (e.g., .../vendor/DAP/networks)
        current_dir = os.path.dirname(os.path.abspath(__file__))

        # Step up one level to the parent folder (e.g., .../vendor/DAP)
        parent_dir = os.path.dirname(current_dir)
        dinov3_repo_dir = os.path.join(parent_dir, "depth_anything_v2_metric", "depth_anything_v2", "dinov3")
